...
void votingtrend()
{
    printf("Candidate1 got %d votes\n",A);
    printf("Candidate2 got %d votes\n",B);
    printf("Candidate3 got %d votes\n",C);
    printf("Candidate4 got %d votes\n",D);
}
...
void main()
{
    ...
    do
    {
        ...
        printf("Press 6 to show voting trend\n");
